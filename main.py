...
def gradient_text(text, colors):
    # Dummy fallback version (real one may differ)
    return text
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold white][bold green](01)[/bold green]: Increase Money                 [bold yellow]rm3[/bold yellow][/bold white]")
            console.print("[bold white][bold green](02)[/bold green]: Increase Coins                 [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](03)[/bold green]: King Rank                      [bold yellow]rm25[/bold yellow][/bold white]")
            console.print("[bold white][bold green](04)[/bold green]: Change ID                      [bold yellow]rm20[/bold yellow][/bold white]")
            console.print("[bold white][bold green](05)[/bold green]: Change Name                    [bold yellow]rm3[/bold yellow][/bold white]")
            console.print("[bold white][bold green](06)[/bold green]: Change Name (rainbow)          [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](07)[/bold green]: Number Plates                  [bold yellow]rm15[/bold yellow][/bold white]")
            ...
            console.print("[bold white][bold green](10)[/bold green]: Delete Friends                 [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](11)[/bold green]: Unlock Lamborghinis (ios only) [bold yellow]rm15[/bold yellow][/bold white]")
            console.print("[bold white][bold green](12)[/bold green]: Unlock All Cars                [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](13)[/bold green]: Unlock All Cars Siren          [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](14)[/bold green]: Unlock W16 Engine              [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](15)[/bold green]: Unlock All Horns               [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](16)[/bold green]: Unlock Disable Damage          [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](17)[/bold green]: Unlock Unlimited Fuel          [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](18)[/bold green]: Unlock Home 3                  [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](19)[/bold green]: Unlock Smoke                   [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](20)[/bold green]: Unlock Wheels                  [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](21)[/bold green]: Unlock Animations              [bold yellow]rm3[/bold yellow][/bold white]")
            console.print("[bold white][bold green](22)[/bold green]: Unlock Equipaments M           [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](23)[/bold green]: Unlock Equipaments F           [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](24)[/bold green]: Change Race Wins               [bold yellow]rm3[/bold yellow][/bold white]")
            console.print("[bold white][bold green](25)[/bold green]: Change Race Loses              [bold yellow]rm3[/bold yellow][/bold white]")
            console.print("[bold white][bold green](26)[/bold green]: Clone Account                  [bold yellow]rm20[/bold yellow][/bold white]")
            console.print("[bold white][bold green](27)[/bold green]: Custom HP                      [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](28)[/bold green]: Custom Angle                   [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](29)[/bold green]: Custom Tire burner             [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](30)[/bold green]: Custom Car Millage             [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](31)[/bold green]: Custom Car Brake               [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](32)[/bold green]: Remove Rear Bumper             [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](33)[/bold green]: Remove Front Bumper            [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](34)[/bold green]: Change Account Password        [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](35)[/bold green]: Change Account Email           [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](36)[/bold green]: Custom Spoiler                 [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](37)[/bold green]: Custom BodyKit                 [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](38)[/bold green]: Unlock Premium Wheels          [bold yellow]rm10[/bold yellow][/bold white]")
            console.print("[bold white][bold green](39)[/bold green]: Unlock Toyota Crown            [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](40)[/bold green]: Unlock Clan Hat (m)            [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](41)[/bold green]: Remove Head Male               [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](42)[/bold green]: Remove Head Female             [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](43)[/bold green]: Unlock Clan Top 1 (m)          [bold yellow]rm8[/bold yellow][/bold white]")
            console.print("[bold white][bold green](44)[/bold green]: Unlock Clan Top 2 (m)          [bold yellow]rm8[/bold yellow][/bold white]")
            console.print("[bold white][bold green](45)[/bold green]: Unlock Clan Top 3 (m)          [bold yellow]rm8[/bold yellow][/bold white]")
            console.print("[bold white][bold green](46)[/bold green]: Unlock Clan Top 1 (fm)         [bold yellow]rm8[/bold yellow][/bold white]")
            console.print("[bold white][bold green](47)[/bold green]: Unlock Clan Top 2 (fm)         [bold yellow]rm8[/bold yellow][/bold white]")
            console.print("[bold white][bold green](48)[/bold green]: Unlock Mercedes Cls            [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](49)[/bold green]: Stance Camber                  [bold yellow]rm5[/bold yellow][/bold white]")
            console.print("[bold white][bold green](50)[/bold green]: Custom HP  All  Cars           [bold yellow]rm15[/bold yellow][/bold white]")
            ...
            console.print("[bold yellow]===============[bold green][ TNC ][/bold green]===============[/bold yellow]")
